...
const OrderScreen = () => {
  ...
  // Move useColorModeValue to the top level - always call it unconditionally
            ...
            <Box mt="8">
              {loadingPay ? (
                ...
                <PayPalScriptProvider
                  options={{
                    "client-id": "AbCWawRqgTtLVVCXOZojr41rc7ooz60ClZWU8y8UynDk3KmHn5syU0o41cyMi5iyh_E3brYWPGuLOFfr",
                    components: "buttons",
                  }}
                >
                  <PayPalButtons
